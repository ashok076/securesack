    ...
    <View>
      ...
      <View style={styles.inputContainer}>
        <InputTextDynamic
          ...
          onChangeText={(policyNumber) => this.setState({policyNumber}, () => this.changesMade())}
      ...
      <View style={styles.inputContainer}>
        <InputTextIconDynamic
          placeholder="Premium"
          icon="dollar-sign"
          onChangeText={(premium) => this.setState({premium}, () => this.changesMade())}
          color={Color.veryLightPink}
  ...
  additionalInformation = () => (
    <View style={styles.miniContainer}>
      ...
      <View style={styles.miniInputContainer}>
        <InputTextDynamic
          placeholder="Ends On"
          onChangeText={(endsOn) => this.setState({endsOn: formatDate(endsOn)}, () => this.changesMade())}
          keyboardType="default"
          color={Color.veryLightPink}
